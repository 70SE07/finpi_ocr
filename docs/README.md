...
### [REORGANIZATION_PLAN.md](./REORGANIZATION_PLAN.md) - План реорганизации

**Текущая задача.** План приведения кодовой базы в соответствие с утверждённой архитектурой:
- Контракты на Pydantic с валидацией
- Пайплайн D2 = 6 этапов (ADR-015)
- Checksum валидация в основном коде
