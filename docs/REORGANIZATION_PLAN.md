...
### Прогресс
- [ ] Фаза 1.1: Контракты на Pydantic
- [ ] Фаза 1.2: Интеграция контрактов в код
- [ ] Фаза 2.1: Структура stages/
- [ ] Фаза 2.2: Реализация этапов и пайплайна
- [ ] Фаза 2.3: Синхронизация документации
...
- [ ] Фаза 3.4: Исправление ошибок в Ground Truth данных
...
|----------|-------|---------|
| Итоговая сумма 12.31 вместо 143.37 | Stage 1 | Исправлена логика определения строк итоговой суммы в Layout Processor |
...
**Файлы:**
- [x] `tests/integration/test_ground_truth.py`
- [x] `tests/integration/test_pipeline_de_DE.py`
- [x] `tests/integration/test_pipeline_pl_PL.py`

---

### 3.5 Исправление ошибок в Ground Truth данных

**Статус:** В ПРОЦЕССЕ

**Проблема:** Тесты на Ground Truth не проходят из-за ошибок в самих данных (несоответствие сумм товаров итоговой сумме).

**Решение:**
- [x] Проверить и исправить файлы Ground Truth в `docs/ground_truth/`
- [ ] Обновить скрипт тестирования для работы с исправленными данными
- [ ] Запустить тесты на исправленных данных

**Обнаруженные проблемы:**
1. В некоторых файлах сумма цен товаров не соответствует итоговой сумме чека
2. Отсутствуют некоторые обязательные поля в структуре данных
...
| 3.3 | Сравнительное тестирование | 🟡 Важно | DONE |
| 3.4 | Интеграционные тесты | 🟡 Важно | DONE |
| 3.5 | Исправление ошибок в Ground Truth | 🟡 Важно | IN PROGRESS |
...
6. ✅ Исправлены ошибки в Ground Truth данных
7. ✅ README с предупреждением о безопасности
