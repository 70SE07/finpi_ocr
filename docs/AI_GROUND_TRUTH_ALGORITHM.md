...
### Ошибка 1: Изменение дефисов и пробелов

| На чеке | Неверно | Верно |
|---------|---------|-------|
| `Zucker - Raffinade` | `Zucker Raffinade` | `Zucker - Raffinade` |
| `БИСКВ.МИРАЖ` | `БИСКВ. МИРАЖ` | `БИСКВ.МИРАЖ` |

**Правило:** Копируй пробелы и дефисы ТОЧНО как на чеке!

### Ошибка 2: "Додумывание" букв и окончаний

| На чеке | Неверно | Верно |
|---------|---------|-------|
| `F&G Häh Min.schn` | `F&G Häh Min.schri` | `F&G Häh Min.schn` |
| `Frischwurst-Sortim` | `Frischwurst-Sortiment` | `Frischwurst-Sortim` |

**Правило:** Если слово обрезано — пиши как обрезано! Не дописывай!

### Ошибка 3: Невнимательность к цифрам

| На чеке | Неверно | Верно |
|---------|---------|-------|
| `Wiesenauel 1` | `Wiesenauel 10` | `Wiesenauel 1` |
| `0,834 kg` | `0,84 kg` | `0,834 kg` |

**Правило:** Цифры копируй ТОЧНО! Не округляй, не додумывай!

### Ошибка 4: "Исправление" сокращений

| На чеке | Неверно | Верно |
|---------|---------|-------|
| `Kern. Roggenvollk.` | `Kern Roggenvollkorn` | `Kern. Roggenvollk.` |
| `Geflügel-Frischwur` | `Geflügel-Frischwurst` | `Geflügel-Frischwur` |

**Правило:** Сокращения — это часть raw_name! Не расшифровывай!

### Ошибка 5: Путаница "l" (литр) и "1" (единица)

| На чеке | Неверно | Верно |
|---------|---------|-------|
| `Coca-Cola 2l` | `Coca-Cola 21` | `Coca-Cola 2l` |
| `Red Bull 0,25l` | `Red Bull 0,251` | `Red Bull 0,25l` |
| `Evian 1,5l` | `Evian 1,51` | `Evian 1,5l` |

**Правило:** Буква "l" (литр) и цифра "1" выглядят похоже!
- Если речь о напитке и объёме — скорее всего это `l` (литр)
- `2l` = 2 литра, `0,25l` = 250 мл
- Контекст: `Coca-Cola 21` не имеет смысла, а `Coca-Cola 2l` — 2 литра

**Как отличить:**
- Смотри на контекст (напиток + число = литры)
- Буква `l` часто идёт сразу после цифры без пробела
- Если сомневаешься — увеличь изображение
